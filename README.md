...
```bash
git clone --single-branch -b laurel_sprout_aetheria-1.0 https://github.com/AetheriaOS-Devices/aetheria_local_manifest/local_manifest.git .repo/local_manifests
```
Then to sync up:
```bash
